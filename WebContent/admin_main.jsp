...
<html>
  <head>
   <jsp:useBean id="mdao" scope="page" class="dao.impl.MscDaoImpl"></jsp:useBean>
    <title></title>
...
int counum=(int)mdao.countCourse(); 
 %>
    ...
    <tr ><td width="50"></td><td height="20" align="left"><font color="#48f9f9"><em><strong>欢迎你,管理员！</strong></em></font></td></tr>
