...
<html>
  ...
  <body>
   ...
   <tr><td height="10" ><font color="#0000ff"><br></font></td></tr>
   <tr><td height="35" align="center" background="image/bgpicture.gif"><font color="#0000ff"><strong><a href="admin_stu_sel.jsp" target="main">模糊查询学生信息</a></strong></font></td></tr>
   <tr><td height="10" ><font color="#0000ff"><br></font></td></tr>
   <tr><td height="35" align="center" background="image/bgpicture.gif"><font color="#0000ff"><strong><a href="admin_stu_upd.jsp" target="main">精确查询学生信息</a></strong></font></td></tr>
<%--   <tr><td height="10" ><font color="#0000ff"><br></font></td></tr>
