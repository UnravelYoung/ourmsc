...
<html>
 ...
 if(id!=null&&kind!="admin")
	...
	<ul class="TabBarLevel1" id="TabPage1">
		...
		<li id="Tab4"><a target="mainframe" href="admin_msc.jsp" onclick="javascript:switchTab('TabPage1','Tab4');">&nbsp; <strong>成 绩 处 理</strong>&nbsp;</a></li>
		<li id="Tab5"><a target="mainframe" href="admin_menu.jsp" onclick="javascript:switchTab('TabPage1','Tab5');">&nbsp;<strong>修 改 密 码</strong>&nbsp;</a></li>
		<li id="Tab6"><a target="_parent" href="login.jsp?action=quit" onclick="javascript:switchTab('TabPage1','Tab6');">&nbsp;<strong>退 出</strong>&nbsp;</a></li>
	</ul>
</div>
